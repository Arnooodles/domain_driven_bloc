...
> This file provides directives for AI agents operating in the `{{project_name.snakeCase()}}` workspace. It should be mirrored across `CLAUDE.md`, `AGENTS.md`, and `GEMINI.md` so the same instructions load in any AI environment.
