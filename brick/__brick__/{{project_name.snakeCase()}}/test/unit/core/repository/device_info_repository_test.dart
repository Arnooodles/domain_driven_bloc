...
import 'package:{{project_name.snakeCase()}}/core/data/repository/device_info_repository.dart';
...
void main() {
  group(DeviceInfoRepository, () {
    ...
    setUp(() {
      ...
      talker = MockTalker();
      deviceRepository = DeviceInfoRepository(packageInfo, deviceInfo, talker);
    });
    ...
    group('getPhoneModel', () {
      test('should return the phone model of android devices', () async {
        ...
        final Result<String> result = await deviceRepository.getPhoneModel().run();
        expect(result, isA<Right<Failure, String>>());
    ...
    group('getPhoneOSVersion', () {
      test('should return os and version of the ios phone', () async {
        ...
        final Result<(String, String)> result = await deviceRepository.getPhoneOSVersion().run();
