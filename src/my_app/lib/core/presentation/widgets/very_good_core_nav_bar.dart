...
class VeryGoodCoreNavBar extends HookWidget implements PreferredSizeWidget {
  const VeryGoodCoreNavBar({required this.navigationShell, this.size, super.key});
    ...
    child: Hidable(
      child: NavigationBar(
        ...
        destinations: <Widget>[
          ...
          NavigationDestination(
            icon: VeryGoodCoreIcon(icon: right(Icons.account_circle_outlined)),
            selectedIcon: VeryGoodCoreIcon(icon: right(Icons.account_circle)),
