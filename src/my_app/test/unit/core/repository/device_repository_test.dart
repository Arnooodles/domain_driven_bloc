...
import 'package:very_good_core/core/data/repository/device_repository.dart';
...
void main() {
  ...
  test(' getAppVersion should return the package version', () async {
  ...
  test(' getBuildNumber should return the build number', () async {
  ...
  test(' getPhoneModel should return the phone model of android devices', () async {
  ...
  test(' getPhoneModel should return the phone model of ios devices', () async {
    const String phoneModel = 'iPhone';

    debugDefaultTargetPlatformOverride = TargetPlatform.iOS;
    when(deviceInfo.iosInfo).thenAnswer((_) => Future<IosDeviceInfo>.value(mockIosDeviceInfo(phoneModel: phoneModel)));

    expect(await deviceRepository.getPhoneModel(), phoneModel);
  });

  test(' getPhoneOSVersion should return os and version of the ios phone', () async {
    const String os = 'iOS';
  ...
  test(' getPhoneOSVersion should return os and version of the android phone', () async {
    const String version = '1.0';
